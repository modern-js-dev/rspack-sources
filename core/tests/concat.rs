...
//   SourceMapSourceOptions, SourceMapSourceSliceOptions, SourceMap,
// };
...
//       source_map: SourceMap::from_buffer("/", &FIXTURE_MINIFY.3).unwrap(),
//       original_source: Some(&FIXTURE_MINIFY.0),
//       inner_source_map: Some(SourceMap::from_buffer("/", &FIXTURE_MINIFY.1).unwrap()),
...
//       name: "bundle.js".into(),
//       source_map: SourceMap::from_buffer("/", &FIXTURE_ROLLUP.1).unwrap(),
